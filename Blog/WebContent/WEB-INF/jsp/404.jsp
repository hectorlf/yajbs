...
<div id="body-wrapper" class="clearfix">
	<header id="header-main" role="banner"> <!-- begin header -->
		<ul id="headerbanner" class="clearfix"><stripes:url beanclass="com.hectorlopezfernandez.action.IndexAction" var="indexUrl"/>
			<li id="header_logo" class="mainl">
				<div id="site-logo" class="siteheader"><h1>Don&apos;t know what you got, till it&apos;s gone</h1> <span style="font-style: italic;">404 Page Not Found</span></div>
			</li>
	...
	<ul id="main-wrapper">
		<li id="maincontent" role="main"> <!-- begin maincontent -->
			<p>No s&eacute; lo que estabas buscando, pero en la URL que has introducido no hay nada.</p>
