...
<c:set var="pageName" value="Nueva entrada"/>
...
<%@include file="/WEB-INF/jsp/admin/layouts/menu.jsp"%>
	...
	<section id="main" class="column">
		<stripes:form beanclass="com.hectorlopezfernandez.action.admin.SavePostAction">
		<article class="module width_full">
			...
			<div class="module_content">
					...
					<fieldset>
						...
						<stripes:text name="headerImageUrl" id="headerImageUrl"/>
					</fieldset>
					<fieldset>
						...
						<stripes:text name="sideImageUrl" id="sideImageUrl"/>
					</fieldset>
					<fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->
						<label>Autor</label>
						<stripes:select name="authorId" style="width:92%;"><stripes:options-collection collection="${actionBean.authors}" label="displayName" value="id"/></stripes:select>
					</fieldset>
					...
					<fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->
						...
						<stripes:select name="tagIds" multiple="multiple" size="5" style="width:92%;height:92px;"><stripes:options-collection collection="${actionBean.tags}" label="name" value="id"/></stripes:select>
					</fieldset>
					<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
						<label>Comentarios</label><div class="clear"></div>
						<div style="margin-left:6px;"><stripes:checkbox name="commentsAllowed"/>Comentarios abiertos</div>
					</fieldset>
					<div class="clear"></div>
			</div>
			<footer>
