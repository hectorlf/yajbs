...
<c:set var="pageName" value="Entradas etiquetadas en '${actionBean.tagName}'"/><c:set var="blogTitle" value="${preferences.title}"/><c:set var="blogTagline" value="${preferences.tagline}"/><c:set var="tag" value="${actionBean.tagName}"/><c:set var="posts" value="${actionBean.posts}"/>
...
<%@include file="/WEB-INF/jsp/fragments/header.jsp"%>
	<ul id="main-wrapper">
		<li id="maincontent" role="main"> <!-- begin maincontent -->
			<header>
				<h1 class="catheader">Entradas etiquetadas en '${actionBean.tagName}'</h1>
			</header>
