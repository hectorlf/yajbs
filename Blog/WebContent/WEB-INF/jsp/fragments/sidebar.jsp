...
<%@include file="/WEB-INF/jsp/fragments/small-search-bar.jsp"%>
			...
			<aside id="linkcat-2" class="side-widget">
				...
				<ul class="xoxo blogroll">
					<li><a href="http://beosman.org/" target="_blank">BeOSman's Blog</a></li>
					<li><a href="http://icoloma.blogspot.com.es/" target="_blank">The 90th percentile</a></li>
					<li><a href="http://www.javahispano.org/" target="_blank">javaHispano</a></li>
					<li><a href="http://android-developers.blogspot.com.es/" target="_blank">Android Developers Blog</a></li>
