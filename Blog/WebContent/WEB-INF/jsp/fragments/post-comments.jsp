...
<%--								<div class="reply">
				...
				<div id="respond">
<c:choose><c:when test="${!post.commentsClosed}">					<h3 id="reply-title">Dejar un comentario</h3>
					<stripes:form beanclass="com.hectorlopezfernandez.action.AddCommentAction" id="commentform">
					<stripes:hidden name="postId" value="${post.id}"/>
					<p class="comment-notes">La direcci&oacute;n de email no ser&aacute; publicada.</p>
					<p class="comment-form-author"><stripes:text id="author" name="author" size="30"/><stripes:errors field="author"/></p>
					...
					<p>${reCaptchaHtml}</p>
					<p class="form-submit"><stripes:submit name="send" value="Enviar comentario"/></p>
					</stripes:form>
